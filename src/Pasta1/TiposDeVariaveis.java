...
public class TiposDeVariaveis {
    /**
     * 3) Variável estática
     * Uma variável que é declarada como estática é chamada de variável estática. Ela não pode ser local. Você pode criar uma única cópia da variável estática e compartilhá-la entre todas as instâncias da classe.
